...
class Solution:
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
        ...
        # opt C create bucket of count to num, possible count from 1 -> len(nums), iterate from highest count, add nums in the bucket count, if result reach k then return -> n
